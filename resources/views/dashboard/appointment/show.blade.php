...
@section('dash-content')
  ...
  <div class="pl-actions">
    ...
    <div class="pl-action-group d-flex align-items-center gap-2 flex-wrap">
      ...
      <a href="{{ route('appointments.cards', request()->query()) }}"
         class="pl-icon-btn"
                  ...
                  @if($canManage)
                    <td class="text-end">
                      <div class="d-inline-flex gap-2">
                        ...
                        @if(auth()->check() && auth()->user()->role === 'admin')
                          <a class="pl-icon-btn" href="{{ route('appointment.reset', $appt->id) }}?no={{ $dayNo }}"
                            target="_blank">
                            <span class="material-icons-round">print</span>
                          </a>
                          <a class="pl-icon-btn vip" href="{{ route('appointment.vipPrint', $appt->id) }}?no={{ $dayNo }}"
                            target="_blank" title="Print VIP Ticket">
