  ...
  <main class="container-fluid py-2 py-md-3">
    ...
    <div class="pt-actions container py-3">
      <div class="d-flex align-items-center justify-content-end gap-2 flex-wrap">
        ...
        @php
          $pdfUrl = route('transfers.pdf', $transfer->id);
          $msg = "🚑 Patient Transfer PDF is ready:\n{$pdfUrl}";
          $phone = session('patient_phone') ?? ($transfer->patient?->phone ?? null);
        @endphp

        @if($phone)
          <a href="https://wa.me/{{ preg_replace('/\D+/', '', $phone) }}?text={{ urlencode($msg) }}" target="_blank"
            class="pt-btn pt-btn-wa text-decoration-none">
            <span class="pt-btn-icon">
              <i class="bi bi-whatsapp"></i>
            </span>
            <span class="pt-btn-text">Send</span>
          </a>
        @else
          ...
          <div class="pt-box">
            ...
            <div class="pt-box-body">
              ...
              <div class="pt-note mt-3" style="margin:0;">
                ...
                @php
                  $equip = [];
                  if ($transfer->continuous_oxygen)
                    $equip[] = 'Continuous Oxygen';
                  if ($transfer->cardiac_monitoring)
                    $equip[] = 'Cardiac Monitoring';
                @endphp
